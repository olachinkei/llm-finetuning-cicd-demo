...
with wandb.init(job_type="model_evaluation") as run:
    ...
    staging_model = model.merge_and_unload()
    ## production model
    ...
    production_model = production.merge_and_unload()
    ...
    run.log({
        ...
        "Validation Responses": get_completion_responses_batch(prompts, base_llm,production_model, stag_model, tokenizer),
